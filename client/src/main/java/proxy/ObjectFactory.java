...
public class ObjectFactory {
    ...
    private final static QName _Compte_QNAME = new QName("http://echcherqaoui.khalid/", "compte");
    private final static QName _Conversion_QNAME = new QName("http://echcherqaoui.khalid/", "conversion");
    private final static QName _ConversionResponse_QNAME = new QName("http://echcherqaoui.khalid/", "conversionResponse");
    private final static QName _GetCompte_QNAME = new QName("http://echcherqaoui.khalid/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://echcherqaoui.khalid/", "getCompteResponse");
    private final static QName _GetComptes_QNAME = new QName("http://echcherqaoui.khalid/", "getComptes");
    private final static QName _GetComptesResponse_QNAME = new QName("http://echcherqaoui.khalid/", "getComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://echcherqaoui.khalid/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://echcherqaoui.khalid/", name = "conversion")
     ...
     */
    @XmlElementDecl(namespace = "http://echcherqaoui.khalid/", name = "conversionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://echcherqaoui.khalid/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://echcherqaoui.khalid/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://echcherqaoui.khalid/", name = "getComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://echcherqaoui.khalid/", name = "getComptesResponse")
