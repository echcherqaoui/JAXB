 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://echcherqaoui.khalid/", wsdlLocation = "http://localhost:8080/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://echcherqaoui.khalid/", "BanqueServiceService");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://echcherqaoui.khalid/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://echcherqaoui.khalid/", "BanqueServicePort"), BanqueService.class, features);
    }
